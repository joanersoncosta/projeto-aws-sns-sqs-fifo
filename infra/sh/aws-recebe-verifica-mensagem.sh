...
//Mandar msg
 aws sns publish --topic-arn arn:aws:sns:us-east-1:588738590129:sns-teste-topic-fifo.fifo --message "Olá, esta é uma mensagem para o tópico FIFO!" --message-group-id "group1" --message-deduplication-id "abc123"